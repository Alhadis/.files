...
user_pref("browser.ml.smartAssist.model",            "");
user_pref("browser.ml.smartAssist.overrideNewTab",   false);
...
user_pref("layout.css.background-clip.border-area.enabled", true);
...
user_pref("layout.css.corner-shape.enabled", true);
user_pref("layout.css.cross-fade.enabled", true);
user_pref("layout.css.custom-media.enabled", true);
user_pref("layout.css.ellipse-corners.enabled", true);
...
user_pref("layout.css.progress-function.enabled", true);
user_pref("layout.css.scroll-driven-animations.enabled", true);
user_pref("layout.css.style-queries.enabled", true);
user_pref("layout.css.supports.at-rule.enabled", true);
user_pref("layout.css.text-decoration-inset-percentage.enabled", true);
user_pref("layout.css.tree-counting-functions.enabled", true);
user_pref("layout.css.typed-om-color.enabled", true);
user_pref("layout.css.typed-om.enabled", true);
user_pref("layout.css.zoom.enabled", true);
user_pref("javascript.options.experimental.import_text", true);
user_pref("javascript.options.experimental.intl_locale_info", true);
user_pref("javascript.options.experimental.iterator_helpers", true);
user_pref("javascript.options.experimental.iterator_includes", true);
user_pref("javascript.options.experimental.json_parse_with_source", true);
user_pref("javascript.options.experimental.regexp_buffer_boundaries", true);
...
user_pref("dom.audio_session.enabled", true);
...
user_pref("dom.documentpip.enabled", true);
user_pref("dom.editcontext.allow_canvas", true);
user_pref("dom.editcontext.enabled", true);
user_pref("dom.element.blocking.enabled", true);
user_pref("dom.element.commandfor.on_details.enabled", true);
...
user_pref("dom.forms.html_color_picker.enabled", true);
user_pref("dom.media.pseudo-classes.enabled", true);
user_pref("dom.paintWorklet.enabled", true);
user_pref("dom.scoped-custom-element-registries.enabled", true);
